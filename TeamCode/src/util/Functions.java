...
public class Functions {
    ...
    public static Position body2field(Position bodyVector, Coordinate currentCoord) {
        ...
        double[][] C_b2f = {{cosd(heading), -sind(heading)},
                {sind(heading), cosd(heading)}};

        fieldVector = transformCoordinates(C_b2f, bodyVector);
        return fieldVector;
    ...
    public static Position field2body(Position fieldVector, Coordinate currentCoord) {
        ...
        double[][] C_f2b = {{cosd(heading), sind(heading)},
                {-sind(heading), cosd(heading)}};
        bodyVector = transformCoordinates(C_f2b, fieldVector);
        return bodyVector;
    ...
    public static Position front2back(Position frontVector) {
        ...
        double[][] C_f2b = {{-1, 0},
                {0, -1}};
        backVector = transformCoordinates(C_f2b, frontVector);
        return backVector;
    }
