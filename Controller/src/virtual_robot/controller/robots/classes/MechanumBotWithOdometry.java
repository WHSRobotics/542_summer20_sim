 ...
 *
 */
@BotConfig(name = "Mechanum Bot with Odometry", filename = "mechanum_bot_with_odometry")
public class MechanumBotWithOdometry extends VirtualBot {
    ...
    private OdometryImpl odometry = null;
    ...
    public MechanumBotWithOdometry(){
        super();
        ...
        odometry = (OdometryImpl)hardwareMap.odometry.get("odometry");
    ...
    protected void createHardwareMap(){
        ...
        hardwareMap.put("odometry", new OdometryImpl());
    }
    ...
    public synchronized void updateStateAndSensors(double millis){
        ...
        odometry.update(dxR*mmPerPixel, dyR*mmPerPixel, headingChange);
