...
/**
 * Complex util.Timer class
 *
 * @see util.SimpleTimer
 */
public class Timer {
    ...
    /**
     * Tells whether or not the timer is elapsed, according to time variable set when the util.Timer was instantiated
