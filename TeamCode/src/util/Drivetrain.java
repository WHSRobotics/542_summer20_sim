...
public class Drivetrain {
    ...
    private static final double TRACK_WIDTH = 406.4;

    //TODO: measure actual wheel base
    private static final double WHEEL_BASE = 355.6;
    ...
    private static final double ENCODER_TICKS_PER_REV = 1120; // <-- omnis  (537.6;      //Orbital 20))
