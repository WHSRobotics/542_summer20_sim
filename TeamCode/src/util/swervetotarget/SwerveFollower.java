...
public class SwerveFollower {
   ...
   SwervePath path;
    ...
    public double[] calculateMotorPowers(Coordinate currentCoord) {
 ...
 /*       if (path.backwards()) {
        ...
        if (indexOfClosestPoint != path.size() - 1) {
            double[] feedBack = /*{currentTargetWheelVelocities[0] - currentWheelVelocities[0], currentTargetWheelVelocities[1] - currentWheelVelocities[1]}*/ {0.0,0.0};
